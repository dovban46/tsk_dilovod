...
<html lang="ua">
<head>
    <title>Адмін-панель випускники</title>
    <meta charset="utf-8">
...
<div class="bg-top navbar-light">
    <div class="container">
        <div class="row no-gutters d-flex align-items-center align-items-stretch">
            ...
            <div class="col-md-4 d-flex align-items-center py-4">
                <p class="navbar-brand">Випускники</p>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="col">
            <table class="table">
                ...
                <tr>
                    ...
                    <th scope="col">ПІБ</th>
                    <th scope="col">Рік</th>
                    <th><a href="index-grup.php" class="btn btn-success">Групи</a></th>
                    <th><a href="add-student.php" class="btn btn-success">Добавити студента</a></th>
                    <th><a href="../index.php" class="btn btn-primary">Назад</a></th>
                </tr>
                </thead>
                <?php $students = get_student();
                foreach ($students as $student):?>
                    <tbody>
                    <tr>
                        <th scope="row"><?=$student['id_students'];?></th>
                        <td><?=$student['LastName']?> <?=$student['FirstName']?> <?=$student['PoBatkovi']?></td>
                        <td><?=$student['year']?></td>
                        <th></th>
                        <th></th>
                        <td><a href="delete-student.php?student_id=<?=$student['id_students']?>" class="btn btn-danger">Видалити</a></td>
                    </tr>
                    </tbody>
                <?php endforeach;?>
            </table>
