...
<div class="bg-top navbar-light">
    <div class="container">
        <div class="row no-gutters d-flex align-items-center align-items-stretch">
            ...
            <div class="col-md-4 d-flex align-items-center py-4">
                <p class="navbar-brand">Добавити випускника</p>
            </div>
        </div>
    </div>
</div>
...
<div class="container mt-5 mb-5">
    <div class="row">
        <div class="col">
            <form action="check-student.php" method="post" enctype="multipart/form-data">
                ...
                <div class="input-group mt-5 mb-5">
                    <label class="input-group-text" for="inputGroupSelect01">Рік випуску</label>
                    <select class="form-select" name="grupa">
                        <option selected>Рік випуску</option>
                        <?php $grups = get_grupa();?>
                        <?php foreach ($grups as $grupa):?>
                            <option value="<?=$grupa['id_grupa']?>"><?=$grupa['year']?></option>
                        <?php endforeach; ?>
                    </select>
                </div>

                <button class="btn btn-primary" type="submit">Додати запис</button>
                <a href="index-student.php" class="btn btn-primary">Скасувати</a>
            </form>
        </div>
    </div>
</div>
