...
<html lang="ua">
<head>
    <title>Адмін-панель виховні</title>
    <meta charset="utf-8">
...
<div class="bg-top navbar-light">
    <div class="container">
        <div class="row no-gutters d-flex align-items-center align-items-stretch">
            ...
            <div class="col-md-4 d-flex align-items-center py-4">
                <p class="navbar-brand">Виховні</p>
            </div>
        </div>
    </div>
</div>
...
<div class="container mt-5 mb-5">
    <div class="row">
        <div class="col">
            <?php
            function get_educational_by_id ($educational_id)
            {
                global $conn;
                $sql = "SELECT * FROM educational WHERE id  = " . $educational_id;
                $result = mysqli_query($conn, $sql);

                $educational = mysqli_fetch_assoc($result);
                return $educational;
            }
            $educational_id = '1';
            $educational = get_educational_by_id($educational_id);
            ?>
            <form action="update-educational.php" method="post" enctype="multipart/form-data">
                <div class="input-group">
                    <input type="hidden" name="id" readonly ="readonly" class="form-control" value="<?=$educational['id']?>">
                </div>
                <div class="input-group mt-5 mb-5">
                    <span class="input-group-text">Текст</span>
                    <textarea class="form-control" name="content" style="height: 1000px"><?=$educational['content']?></textarea>
                </div>
